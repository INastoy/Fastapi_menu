...
class TestMenu:
    ...
    def test_get_menu_ok(self, client, menu):
        ...
        menu_from_db: MenuSchema = MenuSchema.from_orm(menu.get_by_id(self.menu1.id))
    ...
    def test_create_menu_ok(self, client, menu, session):
        ...
        menu_from_db = MenuSchema.from_orm(menu.get_by_id(menu_from_response.id))
    ...
    def test_submenus_count_ok(self, menu, submenu, session):
        new_menu = menu.create(BaseSchema(title='test_submenus_count', description='test_submenus_count'))
        submenu.create(BaseSchema(title='test_submenus_count1', description='test_submenus_count'), menu_id=new_menu.id)
        submenu.create(BaseSchema(title='test_submenus_count2', description='test_submenus_count'), menu_id=new_menu.id)
        submenu.create(BaseSchema(title='test_submenus_count3', description='test_submenus_count'), menu_id=new_menu.id)
    ...
    def test_dishes_count_ok(self, menu, submenu, dish):
        new_menu = menu.create(BaseSchema(title='test_dishes_count', description='test_dishes_count'))
        new_submenu = submenu.create(BaseSchema(title='test_dishes_count', description='test_dishes_count'),
                                     menu_id=new_menu.id)
        dish.create(BaseSchema(title='test_dishes_count1', description='test_dishes_count'), submenu_id=new_submenu.id)
        dish.create(BaseSchema(title='test_dishes_count2', description='test_dishes_count'), submenu_id=new_submenu.id)
        dish.create(BaseSchema(title='test_dishes_count3', description='test_dishes_count'), submenu_id=new_submenu.id)
        refreshed_menu = menu.get_by_id(new_menu.id)
    ...
    def test_cascade_delete_ok(self, menu, submenu, dish):
        new_menu = menu.create(BaseSchema(title='test_cascade_delete', description='test_cascade_delete'))
        new_submenu = submenu.create(BaseSchema(title='test_cascade_delete', description='test_cascade_delete'),
                                     menu_id=new_menu.id)
        new_dish = dish.create(BaseSchema(title='test_cascade_del1', description='test_cascade_del'),
